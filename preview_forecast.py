...
def build():
    ...
    for i in range(DAYS):
        ...
        hist.append({
            ...
            "cond": cond,
            "daytime": {lab: {"date": f"2026-08-{11+k:02d}",
                              "pop_max": [27, 29, 62, 26][k],
                              "pop_mean": [25, 26, 48, 24][k],
                              "rain_mm": [2.1, 0.3, 11.4, 0.0][k],
                              "wet_hours": [4, 0, 8, 0][k],
                              "wet_from": ["08:00", None, "12:00", None][k],
                              "wet_to": ["11:00", None, "19:00", None][k],
                              "t_hi": [22, 21, 20, 18][k], "t_lo": [14, 13, 14, 11][k],
                              "wind_max": [14, 11, 26, 14][k],
                              "cloud_mean": [54, 79, 88, 77][k]}
                        for k, lab in enumerate(("Tue 11", "Wed 12", "Thu 13", "Fri 14"))},
